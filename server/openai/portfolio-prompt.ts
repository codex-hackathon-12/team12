...
const instructions = [
  ...
  "저장소마다 결정 묶음 하나와 낱개 셋까지 냅니다. 저장소가 여럿이면 전부에 대해 내세요 — 앞쪽 몇 개만 묻고 마는 것이 가장 흔한 실패입니다. 물을 것이 없는 저장소만 건너뜁니다.",
  "highlights는 비어 있을 때뿐 아니라 아직 자리가 남았을 때도 묻습니다. 이미 쓴 것과 겹치지 않는 다른 사실을 묻되, 무엇을 더 말해달라는지가 질문 안에서 분명해야 합니다.",
